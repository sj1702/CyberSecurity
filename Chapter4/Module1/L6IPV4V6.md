...
Example: In IP address 192.168.1.1
			- 192.168.1.1 is Dotted decimal Address
			- last .1 is Host address
			- 192.168.1 is Network Address
			- Its 32-bit Address will be 11000000 10101000 00000001 00000001
			- one block of binary code is known as Octet. Example: 11000000 is one octet in above address.
...
Private addresses range available for anyone to use:
...
Incorrect. The 0000 can be shortened to just 0.
...
Incorrect. The final octet can be shortened from 0001 to 1.

D. 2001:db8::ffff:0:1
Correct. This is the shortened version of the address.